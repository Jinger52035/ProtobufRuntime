...
class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED Map
 ...
 public:
  // Iterators
  class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED ABSL_INTERNAL_ATTRIBUTE_VIEW const_iterator
  ...
  class PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED ABSL_INTERNAL_ATTRIBUTE_VIEW iterator
      : private internal::UntypedMapIterator {
    using BaseIt = internal::UntypedMapIterator;
